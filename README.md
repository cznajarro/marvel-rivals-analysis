...
### Percentage of Time Played by Role
![Percentage of Time Played by Role](figures/Percentage_of_Time_Played_by_Role.png)
- As you can tell, I am clearly a tank main. Although, if you look at the the average win rate by role, not counting heroes with under 20 matches (as I did in the query of the Jupyter notebook) the highest average is Duelists with an average of 52.5% which is undoubtedly held up by **Storm** as a high outlier. Strategists follow with a 49.4%, with **Mantis** at the forefront with her 67.9% win rate. Lastly, Vanguards at an average of 47.3% dragged down by **Emma Frost's** measly 36% win rate, which I am incredibly surprised by. Of the Strategists, most of my matches were played with **Gambit**, I pretty much played only **Gambit** the season that he came out but despite that I only achieved a 48.2% win rate. The Duelist with the most matches is undoubtedly **Storm**. Lastly, **Doctor Strange** at the top of not just the Vanguards but all of my characters but I'm starting to think about switching mains to **Storm** to see if her high win rate can hold up in ranked.  

### MVP/SVP Frequency per Match
![MVP SVP Rate](figures/Top_Heroes_by_MVPSVP_Frequency.png)
- Here is the rate of how often I get MVP/SVP ((MVP+SVP)/#_of_matches), so this is a decent metric for individual performance. Here, **Doctor Strange** shows a strong lead with almost a 23% MVP/SVP followed by another Vanguard, **Thor**. **Storm** again shows up in the top 3 with a very strong 16.9% MVP/SVP rate. I would say this indicates strong performance as **Storm** correlates with a high win rate but I believe that a strong individual performance with high kills as **Strange** brings a lot less value, especially if solo-tanking. The last on this chart, **Blade** only has 1 MVP but is there because he has 10 matches so I would hesitate to count that one. 
